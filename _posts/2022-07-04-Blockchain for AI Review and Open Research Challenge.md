...
5. 미래의 AI 응용 프로그램 에 블록체인의 적용과 확대에 관한 Open Research Challenges 개요
...
Table 1은 AI 응용 프로그램 에 관한 몇 가지의 새로운 트렌드와 그것의 장점을 보여준다.
...
AI 응용 프로그램 는 다른 계획들(검색, 최적화, 학습, 지식 탐구, 지식 관리 전략)에 의한 결정들을 자율적으로 운영하는 역할을 한다.

AI 응용 프로그램 의 분산화는 복잡하고 도전적인 작업임을 알고있자.

1) Autonomic Computing

AI 응용 프로그램 의 주요 목표 중 하나는 인터넷 상태, 인과관계, 환경 등을 고려한 합리적인 여러개의 주체들에 의한 완전한 혹은 부분적인 자동 운영이다. 
